  ...
  return (
    ...
    >
      ...
      <LdLabel className="mb-ld-32 w-full">
        Does trigger always focus input?
        <LdSelect
          filter
        ...
        <LdInputMessage mode="info">Try to click the input with different speeds, bug is mostly reproduced when click is around 40ms,
          but sometime it occures also at different timings/speeds</LdInputMessage>
      </LdLabel>
